/*
 * Reverse Walk — Calibration Sketch
 *
 * Walks the robot backward continuously without obstacle detection.
 * Use this to tune servo angles for a balanced reverse gait.
 *
 * Board:   Arduino UNO
...
void setup() {
  ...
  Serial.begin(9600);
  Serial.println("Reverse walk calibration started");
}

void loop() {
  // Left leg reverse step
  monServo_Leftup.write(40);    // upper leg back
  delay(60);
  monServo_Leftlow.write(80);   // lower leg up
  delay(60);
  monServo_Leftup.write(90);    // upper leg forward
  delay(60);
  monServo_Leftlow.write(45);   // lower leg down
  delay(60);

  // Right leg reverse step
  monServo_Rightup.write(120);  // upper leg back
  delay(50);
  monServo_Rightlow.write(110); // lower leg up
  delay(50);
  monServo_Rightup.write(90);   // upper leg forward
  delay(50);
